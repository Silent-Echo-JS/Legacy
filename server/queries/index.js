...
const findUser = (user) => new Promise((resolve, reject) => {
  ...
  sequelize.query(foundUser, [user], (err, results, fields) => {
    if (results.length > 0) {
      return reject(user);
    }
...
const saveUser = (user) => new Promise((resolve, reject) => {
  ...
  sequelize.query(userInsert, [insertValues], (err, results, fields) => {
    if (err) {
      console.log(err);
      return reject(err);
    }
...
const saveUsersPostCount = (userId) => new Promise((resolve, reject) => {
  ...
  sequelize.query(countInsert, [userId], (err, results) => {
    if (err) {
      console.log(err);
      return reject(err);
    }
...
const savePost = (post) => new Promise((resolve, reject) => {
  ...
  sequelize.query(postInsert, [insertValues], (err, results) => {
    if (err) {
      console.log(err);
      return reject(err);
    }
...
const increasePostCount = (userId) => new Promise((resolve, reject) => {
  ...
  sequelize.query(increaseInsert, [userId], (err, results) => {
    if (err) {
      console.log(err);
      return reject(err);
    }
...
const displayPosts = () => new Promise((resolve, reject) => {
  ...
  sequelize.query(fetchedPosts, (err, results) => {
    if (err) {
      return reject(err);
    }
    return resolve(results);
...
const searchTags = (tag) => new Promise((resolve, reject) => {
  ...
  sequelize.query(searchedTag, (err, results) => {
    if (err) {
      return reject(err);
    }
    return resolve(results);
...
const getPostInfo = (userId) => new Promise((resolve, reject) => {
  ...
  sequelize.query(userIdInsert, [userId], (err, results) => {
    if (err) {
      console.log(err);
      return reject(err);
    }
